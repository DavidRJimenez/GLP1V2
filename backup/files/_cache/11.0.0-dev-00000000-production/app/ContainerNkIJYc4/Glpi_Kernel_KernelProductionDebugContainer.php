...
class Glpi_Kernel_KernelProductionDebugContainer extends Container
{
    ...
    {
        $container->services['event_dispatcher'] = $instance = new \Symfony\Component\HttpKernel\Debug\TraceableEventDispatcher(new \Symfony\Component\EventDispatcher\EventDispatcher(), ($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)), ($container->services['logger'] ?? $container->get('logger', 2)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()));

        $instance->addListener('kernel.controller', [#[\Closure(name: 'Glpi\\Kernel\\Listener\\ControllerListener\\CheckCsrfListener')] fn () => ($container->privates['Glpi\\Kernel\\Listener\\ControllerListener\\CheckCsrfListener'] ??= new \Glpi\Kernel\Listener\ControllerListener\CheckCsrfListener()), 'onKernelController'], 0);
        ...
        $instance->addListener('Glpi\\Kernel\\PostBootEvent', [#[\Closure(name: 'Glpi\\Kernel\\Listener\\PostBootListener\\CustomObjectsAutoloaderRegistration')] fn () => ($container->privates['Glpi\\Kernel\\Listener\\PostBootListener\\CustomObjectsAutoloaderRegistration'] ??= new \Glpi\Kernel\Listener\PostBootListener\CustomObjectsAutoloaderRegistration()), 'onPostBoot'], 140);
        $instance->addListener('Glpi\\Kernel\\PostBootEvent', [#[\Closure(name: 'Glpi\\Kernel\\Listener\\PostBootListener\\CustomObjectsBootstrap')] fn () => ($container->privates['Glpi\\Kernel\\Listener\\PostBootListener\\CustomObjectsBootstrap'] ??= new \Glpi\Kernel\Listener\PostBootListener\CustomObjectsBootstrap()), 'onPostBoot'], 120);
        $instance->addListener('Glpi\\Kernel\\PostBootEvent', [#[\Closure(name: 'Glpi\\Kernel\\Listener\\PostBootListener\\DisablePluginsOnVersionChange')] fn () => ($container->privates['Glpi\\Kernel\\Listener\\PostBootListener\\DisablePluginsOnVersionChange'] ??= new \Glpi\Kernel\Listener\PostBootListener\DisablePluginsOnVersionChange()), 'onPostBoot'], 135);
        $instance->addListener('Glpi\\Kernel\\PostBootEvent', [#[\Closure(name: 'Glpi\\Kernel\\Listener\\PostBootListener\\InitializeCache')] fn () => ($container->privates['Glpi\\Kernel\\Listener\\PostBootListener\\InitializeCache'] ??= new \Glpi\Kernel\Listener\PostBootListener\InitializeCache()), 'onPostBoot'], 170);
        $instance->addListener('Glpi\\Kernel\\PostBootEvent', [#[\Closure(name: 'Glpi\\Kernel\\Listener\\PostBootListener\\InitializeDbConnection')] fn () => ($container->privates['Glpi\\Kernel\\Listener\\PostBootListener\\InitializeDbConnection'] ??= new \Glpi\Kernel\Listener\PostBootListener\InitializeDbConnection()), 'onPostBoot'], 180);
        $instance->addListener('Glpi\\Kernel\\PostBootEvent', [#[\Closure(name: 'Glpi\\Kernel\\Listener\\PostBootListener\\InitializePlugins')] fn () => ($container->privates['Glpi\\Kernel\\Listener\\PostBootListener\\InitializePlugins'] ?? $container->load('getInitializePluginsService')), 'onPostBoot'], 130);
        $instance->addListener('Glpi\\Kernel\\PostBootEvent', [#[\Closure(name: 'Glpi\\Kernel\\Listener\\PostBootListener\\LoadLanguage')] fn () => ($container->privates['Glpi\\Kernel\\Listener\\PostBootListener\\LoadLanguage'] ??= new \Glpi\Kernel\Listener\PostBootListener\LoadLanguage()), 'onPostBoot'], 150);
        $instance->addListener('Glpi\\Kernel\\PostBootEvent', [#[\Closure(name: 'Glpi\\Kernel\\Listener\\PostBootListener\\LoadLegacyConfiguration')] fn () => ($container->privates['Glpi\\Kernel\\Listener\\PostBootListener\\LoadLegacyConfiguration'] ??= new \Glpi\Kernel\Listener\PostBootListener\LoadLegacyConfiguration()), 'onPostBoot'], 160);
        $instance->addListener('Glpi\\Kernel\\PostBootEvent', [#[\Closure(name: 'Glpi\\Kernel\\Listener\\PostBootListener\\ProfilerStart')] fn () => ($container->privates['Glpi\\Kernel\\Listener\\PostBootListener\\ProfilerStart'] ??= new \Glpi\Kernel\Listener\PostBootListener\ProfilerStart()), 'onPostBoot'], 190);
        $instance->addListener('Glpi\\Kernel\\PostBootEvent', [#[\Closure(name: 'Glpi\\Kernel\\Listener\\PostBootListener\\SessionStart')] fn () => ($container->privates['Glpi\\Kernel\\Listener\\PostBootListener\\SessionStart'] ??= new \Glpi\Kernel\Listener\PostBootListener\SessionStart(\dirname(__DIR__, 5))), 'onPostBoot'], 200);
    ...
    {
        return $container->privates['Glpi\\Kernel\\Listener\\ControllerListener\\FirewallStrategyListener'] = new \Glpi\Kernel\Listener\ControllerListener\FirewallStrategyListener(new \Glpi\Http\Firewall());
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'glpi.default_secret' => '09ae29b6d29de4f9a993a366f350f5609ead0efbf56bbd3728d3081a7aa3e6b3',
